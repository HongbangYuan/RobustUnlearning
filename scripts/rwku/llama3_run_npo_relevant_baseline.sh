  ...
  do
    for loss_type in "${loss_types[@]}"
      do
        ...
        output_dir="./saves/RWKU/llama3_8b_instruct/AdvNPO_loss_type_${loss_type}/Target/${id}"
        mkdir -p ${output_dir}
...
do
  ...
  do
      ...
      do
        ...
        echo "------------${id}---------------"
        echo "------------------Loss Type:${loss_type}----------------------------"
        output_dir="./saves/RWKU/llama3_8b_instruct/NPO_loss_type_${loss_type}/Target/${id}"
        mkdir -p ${output_dir}
        log_file="${output_dir}/log_file.txt"
        echo "outputdir:${output_dir}"
        echo "log file:${log_file}"
